...
#[derive(Debug)]
pub struct GuardSphereProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GuardSphereProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GuardSphere processing");
    
    let mut processor = GuardSphereProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GuardSphereProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GuardSphereProcessor::new(false);
